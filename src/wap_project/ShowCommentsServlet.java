	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
	        ...
	        String query = request.getParameter("show");
			    ...
			    String query1 = "SELECT comments.comment FROM answers INNER JOIN comments ON comments.id_answer=answers.id_answer WHERE answers.answer=\'"+result+"\'";
		        ...
		        //out.println("query: "+query1);
					...
					out.println("<button class=\"btn3\" onclick=\"goBack()\">Go Back</button><script>function goBack() {window.history.back();}</script>");
